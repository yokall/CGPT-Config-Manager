...
is($config_manager->get_option('nonexistent'), undef, 'A 1 part key that doesn\'t exisst should return undef');
is($config_manager->get_option('file.nonexistent'), undef, 'A 2 part key that doesn\'t exisst should return undef');
